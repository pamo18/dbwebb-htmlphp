...
$DBsearch_page = [
    "contents" => [
        ...
        "file" => __DIR__ . "/$base-search/contents.php",
        "type" => "movieDB",
        "nav" => "under"
    ]
];
...
$all_pages = array_merge($pages_me, $multipage, $pages_session, $redirect, $login_page, $DBjetty_page, $DBsearch_page, $DBadmin_page, $DBProcess);
